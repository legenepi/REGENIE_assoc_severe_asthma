...
#PBS -N regenie12_broadpheno_adultonset
#PBS -j oe
#PBS -o log
...
pheno="broad_pheno_adultonset" #to change in "broad_pheno_childhoodonset" if for male

# to run: qsub -t 1-22 src/broad_phenotype/ageonset_run_regenie_step1_2.sh
