...
#to change in "broad_pheno_childhoodonset" if for childhood
#to change in "broad_pheno_adultonset" if for adulthood

# to run: qsub src/broad_phenotype/ageonset_run_regenie_step1.sh
