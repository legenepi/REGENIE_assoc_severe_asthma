...
#PBS -N regenie12_broadpheno_childonset
#PBS -j oe
#PBS -o log_step2_ageonset
...
pheno="broad_pheno_childhoodonset"

#to change in "broad_pheno_childhoodonset" if childonset
#to change in "broad_pheno_adultonset" if adultonset

# to run: qsub -t 1-22 src/broad_phenotype/ageonset_run_regenie_step2.sh
